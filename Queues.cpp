...
* menggunakan sruktur data queues dengan pendekatan circular arrays.
* 
* @section Operations
...
* @date 2025-06-24
* 
* @copyright rara.andini.ft24@mail.umy.ac.id (c) 2025
*/
...
/**
 * @class Queues
 * @brief calss ini untuk operasi lengkap queues
 * 
 * 
 */
class Queues 
...
public:
    ...
    /**
     * @brief method untuk menghapus data dalam antrian element 
     * data dihapuskkan dari dalam variable queue_array element terakhir pada variable rear
     */
    void remove()
    {
    ...
    void display()
    {
        ...
        {
            // Jika FRONT_position > RERA_position, iterasi FRONT hingga akhir array
